...
interface Props { activity: Extract<Activity, { type: 'BONUS' }> }

export function BonusActivity({ activity }: Props) {
    return (
        <div className="p-4 bg-amber-50 border-2 border-amber-300 rounded-lg">
            <p className="font-bold text-amber-800 mb-2">⭐ Reto Creativo:</p>
